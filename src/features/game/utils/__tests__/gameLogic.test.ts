...
describe('gameLogic', () => {
  ...
  describe('createGameState', () => {
    ...
    it('should create game state with custom starting score', () => {
      const gameState = createGameState(['Player1'], 301);
  ...
  describe('updatePlayerScore', () => {
    ...
    beforeEach(() => {
      gameState = createGameState(['Alice', 'Bob']);
    });
    ...
    it('should handle bust when score would be 1', () => {
      const gameStateWith2 = createGameState(['Alice'], 2);
      const gameWithTurnStart = {
        ...gameStateWith2,
    ...
    it('should handle bust when score exceeds remaining points', () => {
      const gameStateWith80 = createGameState(['Alice'], 80);
      const gameWithTurnStart = {
        ...gameStateWith80,
  ...
  describe('nextPlayer', () => {
    ...
    beforeEach(() => {
      gameState = createGameState(['Alice', 'Bob', 'Charlie']);
    });
  ...
  describe('resetGame', () => {
    ...
    it('should reset High-Low players to score 40', () => {
      let gameState = createGameState(['Alice', 'Bob'], 501, 'high-low', 3);
